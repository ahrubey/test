...
type str_memorystatus from structure within u_external_function_unicode
end type
end forward
...
Subroutine GlobalMemoryStatusEx(ref str_memorystatusex memorystatusex) Library "KERNEL32.DLL"
...
str_memorystatusex lstr_momoryex

lstr_momoryex.sul_dwlength=64
Globalmemorystatusex(lstr_momoryex)

return (lstr_momoryex.sul_dwavailpagefile)
end function
